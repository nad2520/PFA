// Data is scoped in an IIFE so `const` names (books, genres, …) do not collide with
// app.js when both run as classic scripts (they share one global lexical environment).
(function () {
'use strict';
...
const genreCovers = {
  "Fantasy":           "view/user_page/assets/cover-fantasy.png",
  "Horror":            "view/user_page/assets/cover-horror.png",
  "Mystery":           "view/user_page/assets/cover-mystery.png",
  "Crime":             "view/user_page/assets/cover-crime.png",
  "Romance":           "view/user_page/assets/cover-romance.png",
  "Drama":             "view/user_page/assets/cover-drama.png",
  "Historical Fiction":"view/user_page/assets/cover-historical.png",
};
