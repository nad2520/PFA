...
function initGlobalHeader() {
    ...
    function update() {
        ...
        if (lumoThumb) {
            lumoThumb.src = isWorried ? 'view/admin_page/assets/lumo-worried.png' : 'view/admin_page/assets/lumo-happy.png';
        }
        const avatarBtn = document.getElementById('avatarImg');
        if (avatarBtn) avatarBtn.src = isWorried ? 'view/admin_page/assets/lumo-worried.png' : 'view/admin_page/assets/lumo-happy.png';
    }
...
function initChatbot() {
    ...
    function appendMsg(role, text) {
        ...
        if (!isUser) div.innerHTML = `<img src="view/admin_page/assets/lumo-happy.png" alt="">`;
...
function initProfile() {
    ...
    if (mapBody) {
        ...
        ${i === hero ? `<img src="view/admin_page/assets/lumo-happy.png" class="hero-sprite animate-breathe" alt="You">` : ''}
        ...
        mapBody.innerHTML = `<img src="view/admin_page/assets/scholars-map.png" alt="Scholar's Map">${nodesHTML}`;
    }
