...
<head>
  ...
  <link rel="stylesheet" href="view/landing_page/common/styles/lexora-bundle.css">
  <link rel="stylesheet" href="view/landing_page/components/footer/style.css">
</head>
...
═══════════════════════════════════════ -->
  <div id="splash-page">
    ...
    <div class="splash-image-wrap" id="splash-img">
      <img src="view/landing_page/assets/img_1.png" alt="Lexora — Enter the World of Reading Adventure"
...
═══════════════════════════════════════ -->
  <div id="main-page">
    ...
    <nav class="navbar">
      <div class="navbar-inner">
        <div style="display:flex;align-items:center;gap:1rem;">
          <a href="#" class="navbar-logo">
            <img src="view/landing_page/assets/img_2.jpeg" alt="Lexora" class="navbar-logo-bear-img"
          ...
          <div class="navbar-coins">
            <img src="view/landing_page/assets/img_3.png" alt="coins" style="width:20px;height:20px;object-fit:contain;">
            <span>1,250</span>
          </div>
        </div>
      ...
      <div class="mobile-menu" id="mobile-menu">
        <div class="mobile-menu-coins">
          <img src="view/landing_page/assets/img_3.png" alt="coins" style="width:20px;height:20px;object-fit:contain;"> 1,250
          Coins
        </div>
    ...
    <section class="hero-section">
      <div class="hero-video-wrap">
        ...
        <video autoplay muted loop playsinline
          ...
          <source src="view/landing_page/assets/hero-bg.mp4" type="video/mp4" />
        </video>
      ...
      <div class="section-inner">
        ...
        <div class="steps-grid">
          <div class="card step-card reveal reveal-delay-1">
            ...
            <div class="step-img-wrap">
              <img src="view/landing_page/assets/img_5.png" alt="Browse" class="step-img"
          ...
          <div class="card step-card reveal reveal-delay-2">
            ...
            <div class="step-img-wrap">
              <img src="view/landing_page/assets/img_6.png" alt="Buy" class="step-img"
                style="width:64px;height:64px;object-fit:contain;">
            </div>
          ...
          <div class="card step-card reveal reveal-delay-3">
            ...
            <div class="step-img-wrap">
              <img src="view/landing_page/assets/img_7.png" alt="Earn" class="step-img"
                style="width:64px;height:64px;object-fit:contain;">
            </div>
        ...
        <div class="coin-box reveal">
          <div class="coin-img-wrap">
            <img src="view/landing_page/assets/img_3.png" alt="Lexora Coin"
              style="width:96px;height:96px;object-fit:contain;" class="animate-float">
        ...
        <div class="lumo-box reveal">
          <img src="view/landing_page/assets/img_9.png" alt="Lumo the Bear"
            style="width:112px;height:112px;object-fit:contain;" class="animate-float">
          <div>
        ...
        <div class="services-grid">
          <div class="card service-card reveal reveal-delay-1">
            ...
            <div class="service-header">
              <img src="view/landing_page/assets/img_10.png" alt="Discovery"
          ...
          <div class="card service-card reveal reveal-delay-2">
            <div class="card-hover-overlay"></div>
            <div class="service-header">
              <img src="view/landing_page/assets/img_11.png" alt="Reading"
                style="width:56px;height:56px;object-fit:contain;">
          ...
          <div class="card service-card reveal reveal-delay-3">
            <div class="card-hover-overlay"></div>
            <div class="service-header">
              <img src="view/landing_page/assets/img_12.png" alt="Cart" style="width:56px;height:56px;object-fit:contain;">
          ...
          <div class="card service-card reveal reveal-delay-1">
            <div class="card-hover-overlay"></div>
            <div class="service-header">
              <img src="view/landing_page/assets/img_13.png" alt="AI" style="width:56px;height:56px;object-fit:contain;">
          ...
          <div class="card service-card reveal reveal-delay-2">
            <div class="card-hover-overlay"></div>
            <div class="service-header">
              <img src="view/landing_page/assets/img_14.png" alt="Mood" style="width:56px;height:56px;object-fit:contain;">
          ...
          <div class="card service-card reveal reveal-delay-3">
            <div class="card-hover-overlay"></div>
            <div class="service-header">
              <img src="view/landing_page/assets/img_15.png" alt="Gamification"
                style="width:56px;height:56px;object-fit:contain;">
      ...
      <div class="section-inner">
        ...
        <div class="features-grid">
          <div class="card feature-card reveal reveal-delay-1">
            <div class="card-hover-overlay"></div>
            <div class="feature-icon-wrap"><img src="view/landing_page/assets/img_16.png" alt="Library"
          ...
          <div class="card feature-card reveal reveal-delay-2">
            <div class="card-hover-overlay"></div>
            <div class="feature-icon-wrap"><img src="view/landing_page/assets/img_17.png" alt="Quests"
                style="width:64px;height:64px;object-fit:contain;"></div>
          ...
          <div class="card feature-card reveal reveal-delay-3">
            <div class="card-hover-overlay"></div>
            <div class="feature-icon-wrap"><img src="view/landing_page/assets/img_18.png" alt="Map"
                style="width:64px;height:64px;object-fit:contain;"></div>
          ...
          <div class="card feature-card reveal reveal-delay-4">
            <div class="card-hover-overlay"></div>
            <div class="feature-icon-wrap"><img src="view/landing_page/assets/img_19.png" alt="Guild"
                style="width:64px;height:64px;object-fit:contain;"></div>
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:1.5rem;">
          ...
          <div class="portal-card reveal reveal-delay-1"
            ...
            <div style="aspect-ratio:1;overflow:hidden;">
              <img src="view/landing_page/assets/img_20.jpeg" alt="Fantasy Peaks"
          ...
          <div class="portal-card reveal reveal-delay-2"
            style="position:relative;border-radius:1rem;overflow:hidden;cursor:pointer;transition:transform 0.3s;">
            <div style="aspect-ratio:1;overflow:hidden;">
              <img src="view/landing_page/assets/img_21.jpeg" alt="Mystery Woods"
                style="width:100%;height:100%;object-fit:cover;transition:transform 0.7s;" class="portal-img"
                loading="lazy">
            </div>
            <div
          ...
          <div class="portal-card reveal reveal-delay-3"
            style="position:relative;border-radius:1rem;overflow:hidden;cursor:pointer;transition:transform 0.3s;">
            <div style="aspect-ratio:1;overflow:hidden;">
              <img src="view/landing_page/assets/img_22.jpeg" alt="Scholar's Archive"
                style="width:100%;height:100%;object-fit:cover;transition:transform 0.7s;" class="portal-img"
                loading="lazy">
            </div>
            <div
          ...
          <div class="portal-card reveal reveal-delay-4"
            style="position:relative;border-radius:1rem;overflow:hidden;cursor:pointer;transition:transform 0.3s;">
            <div style="aspect-ratio:1;overflow:hidden;">
              <img src="view/landing_page/assets/img_23.jpeg" alt="Traveler's Tavern"
                style="width:100%;height:100%;object-fit:cover;transition:transform 0.7s;" class="portal-img"
                loading="lazy">
            </div>
            <div
      ...
      <div class="section-inner" style="position:relative;z-index:1;">
        ...
        <div class="stats-grid">
          <div class="card stat-card reveal reveal-delay-1">
            <img src="view/landing_page/assets/img_16.png" alt=""
          ...
          <div class="card stat-card reveal reveal-delay-2">
            <img src="view/landing_page/assets/img_25.png" alt=""
              style="width:2rem;height:2rem;object-fit:contain;margin:0 auto 0.75rem;display:block;">
    ...
    <section id="cta" class="cta-section">
      ...
      <div class="cta-inner">
        <img src="view/landing_page/assets/img_28.png" alt="Lumo" class="cta-emoji reveal animate-float"
    ...
    <section class="vf-section">
      <video id="footer-vid" autoplay muted loop playsinline>
        <source src="view/landing_page/assets/lexora-intro.mp4" type="video/mp4">
      </video>
  ...
  <!-- Modular Scripts -->
  <script src="script/landing_page/components/splash/script.js"></script>
  <script src="script/landing_page/components/navbar/script.js"></script>
  <script src="script/landing_page/components/hero/script.js"></script>
  <script src="script/landing_page/components/video-footer/script.js"></script>
  <script src="script/landing_page/components/get-started-modal/script.js"></script>
  <script src="script/landing_page/components/auth-modal/script.js"></script>
  <script src="script/landing_page/components/footer/script.js"></script>
  <script src="script/landing_page/common/scripts/global.js"></script>
</body>
