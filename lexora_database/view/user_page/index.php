...
<body>
  ...
  <section class="hero-section">
    <div class="hero-media">
      <video autoplay loop muted playsinline poster="view/user_page/assets/hero-library.png">
        <source src="view/user_page/assets/hero-library.mp4" type="video/mp4">
      </video>
    </div>
  ...
  <div id="mapOverlay" class="modal-overlay hidden">
    <div class="modal-box map-dialog">
      ...
      <div class="reading-kingdom-map-wrap">
        ...
        <img src="view/user_page/assets/reading-kingdom-map.png" alt="Reading Kingdom Map" class="reading-kingdom-map-img"
          draggable="false">
  ...
  <div id="lumoOverlay" class="modal-overlay hidden">
    <div class="modal-box" style="position:relative">
      ...
      <div class="lumo-welcome">
        <img src="view/user_page/assets/lumo-happy.png" alt="Lumo the bear" class="animate-breathe">
