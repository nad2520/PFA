...
<head>
    ...
    <link rel="stylesheet" href="/lexora/public/assets/css/admin/main.css">
    <link rel="stylesheet" href="/lexora/public/assets/css/admin/admin.css">
...
<body class="admin-page">
    ...
    <script src="/lexora/public/assets/js/pages/admin-data.js"></script>
    <script src="/lexora/public/assets/js/pages/admin.js"></script>
    <script src="/lexora/public/assets/js/pages/admin-books.js"></script>
    <script>
        ...
        function openAddBookModal() {
            const html = `
                <form id="addBookForm" method="POST" action="../../controller/add_book.php">
        ...
        function openEditBookModal(id, title, author, genre, cover, coinCost, xpReward, coinReward, audience, trending) {
            const html = `
                <form id="editBookForm" method="POST" action="../../controller/update_book.php">
    ...
    <!-- BOOK CRUD: Initialize books management -->
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            if (typeof initBooksManagement === 'function') {
                initBooksManagement();
            }
        });
    </script>
